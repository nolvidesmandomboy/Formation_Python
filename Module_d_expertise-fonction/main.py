...
def recuperer_info_personnes (number) :
    ...
    return nom_personne, age_personne # <- Permet de retourner les valeurs qui vont servir de paramètres dans la fonction afficher info personnes
    

def recuperer_et_afficher_infos_personne(numero_personne):
    nom_de_la_personne, age_de_la_personne = recuperer_info_personnes (numero_personne) # <- La virgule ici permet de retourner deux valeurs 
    afficher_info_personnes (numero_personne,nom_de_la_personne,age_de_la_personne)
